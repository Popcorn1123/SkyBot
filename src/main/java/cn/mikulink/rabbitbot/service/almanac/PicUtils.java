...
public class PicUtils {
     ...
     */
    public static File getHuangLi(String username, TodayInfo todayInfo, String targetPath) {
        // 画图
        ...
        printGraph(username, graphics2D, 60, 100, luckMiddle, unluckMiddle, srcImgHeight, srcImgWidth, todayInfo, limit);
...
//        graphics2D.dispose();
    ...
    private static void addLuckText(List<Goods> goodsList, Graphics2D graphics2D, int x, int y, int limit, boolean isLuck) {
        ...
        goodsList.forEach(goods -> {
            ...
            addText2Pic(
                    ...
                    new Font("NLXJT", Font.BOLD, 30),
                    graphics2D);
            height.addAndGet(5);
            addTextWithSwitch(graphics2D, luck, height, x, limit, 25, "NLXJT", Font.PLAIN, new Color(119, 140, 145, 255));
            height.addAndGet(40);
        });
    }
     ...
     * @param limit 限制字数
     */
    private static void printGraph(String username, Graphics2D graphics2D, int titleHeight, int dateHeight, int luckMiddle, int unluckMiddle, int srcImgHeight, int srcImgWidth, TodayInfo todayInfo, int limit) {
        int height = 0;
    ...
    private static int getImageHeight(TodayInfo todayInfo, int limit, boolean isluck) {
        ...
        List<Goods> goodList = todayInfo.getGoodList();
